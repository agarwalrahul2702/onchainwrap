...
const LoaderScreen = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[280px] sm:min-h-[350px] lg:min-h-[400px] space-y-5 sm:space-y-6 lg:space-y-8 animate-fade-in px-4 sm:px-0">
      {/* Animated loader */}
      <div className="relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4 rounded-full bg-primary animate-pulse" />
        </div>
      </div>

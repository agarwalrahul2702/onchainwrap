...
const AddressInput = ({
  ...
  return <div className="space-y-2 sm:space-y-3 lg:space-y-[1.2vh] mx-0 w-full my-3 sm:my-4 lg:my-[31px] mb-3 sm:mb-4 lg:mb-[30px] px-1 sm:px-2 lg:px-0">
      ...
      {/* Twitter input field */}
      <div className="relative mx-2 sm:mx-[20px]">
        <div className="absolute left-2 sm:left-2.5 lg:left-[0.7vw] top-1/2 -translate-y-1/2 text-[#1DA1F2]">
        ...
        <input 
          ...
          disabled={isLoading} 
          className="w-full bg-[#1a1d2e] border border-border/30 rounded-lg pl-8 sm:pl-10 lg:pl-[2.5vw] pr-2 sm:pr-3 lg:pr-[1vw] py-2.5 sm:py-3 lg:py-[1.2vh] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-[#1DA1F2]/30 transition-all font-mono text-[11px] sm:text-xs lg:text-[0.9vw] mt-0 mb-2 sm:mb-3 lg:mb-[15px]" 
        />
      </div>

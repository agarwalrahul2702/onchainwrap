      ...
      >
        ...
        >
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: `${Math.max(2, 6 * scaleFactor)}px` }}>
            <span
              style={{
                color: "#22c55e",
                fontSize: scaleFactor < 0.6 ? `${Math.max(4,16 * scaleFactor)}px` : `${Math.max(9, 20 * scaleFactor)}px`,
                fontWeight: 500,
                lineHeight: 1,
        ...
        >
          ...
          <span
            style={{
              color: "#60a5fa",
              fontSize: scaleFactor < 0.6 ? `${Math.max(4, 8 * scaleFactor)}px` : `${Math.max(10, 14 * scaleFactor)}px`,
              fontWeight: 500,
              lineHeight: 1,

      ...
      <div className="relative z-10 flex-1 pb-4 sm:pb-8 flex-col px-0 flex items-center justify-start my-4 sm:my-6 lg:my-[60px] lg:scale-[0.94] lg:origin-top">
        {appState === "input" && (
          <>
            ...
            <h1 className="font-sans font-bold text-center mb-3 sm:mb-4 lg:mb-6 animate-fade-in text-lg sm:text-xl lg:text-[38px] lg:leading-[56px] leading-tight lg:w-[460px] lg:h-[56px] px-2 whitespace-nowrap">

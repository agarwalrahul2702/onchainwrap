...
const Index = () => {
  ...
  return <main className="relative w-full lg:w-[1440px] min-h-screen lg:h-[932px] mx-auto flex-col overflow-hidden flex items-center justify-center px-4 lg:px-0">
      ...
      {appState !== "result" && <header className="relative z-10 pt-6 lg:pt-8 pb-4">
      ...
      <div className="relative z-10 flex-1 pb-8 flex-col px-0 flex items-center justify-start my-6 lg:my-[60px] lg:scale-[0.94] lg:origin-top">
        {appState === "input" && <>
            ...
            <div className="liquid-glass-card w-[90vw] lg:w-[35vw] min-h-[320px] lg:min-h-0 lg:h-[36vh] my-0 mx-0 lg:py-[2vh] flex-col lg:px-0 flex items-center justify-center px-[20px] py-0">
              <div className="space-y-4 lg:space-y-[2vh] text-center py-0 my-0 w-full">
                <div className="space-y-0 -mt-[10px]">
                  <p className="text-foreground font-sans text-sm lg:whitespace-nowrap font-medium pt-0 px-2 lg:px-[2.5vw] py-[0.2vh] text-center mt-0 lg:mt-[15px] my-px mb-[5px] lg:text-xl">
                    See everything your wallet cooked
                  </p>
                  <p className="text-foreground font-sans text-sm font-medium lg:text-lg">(or didn't)</p>
                </div>

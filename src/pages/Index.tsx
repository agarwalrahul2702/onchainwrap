...
const Index = () => {
  ...
  return <main className="relative w-[1440px] h-[932px] mx-auto flex flex-col overflow-hidden">
      ...
      {/* Main content */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center pb-8 px-0">
        {appState === "input" && <>
          ...
          lineHeight: '72px'
            ...
            <div className="liquid-glass-card w-[517px] h-[342px] my-0 mx-0 px-[20px] py-[16px] items-center justify-end flex flex-col">
              <div className="space-y-5 text-center">
                <div className="space-y-0">
                  <p className="text-foreground font-sans whitespace-nowrap text-2xl font-medium text-justify pt-0 pr-[40px] pl-[40px]">
